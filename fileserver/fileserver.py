...
def add_watermark(image_data):
    """Add AIML logo watermark to the image"""
    try:
        # Open the image from binary data
        img = Image.open(io.BytesIO(image_data))
        
        # Open the watermark image
        watermark_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "public", "aimlLogo.png")
        ...
        # Resize watermark to be proportional to the image (20% of width)
        ...
        # Paste the watermark in the bottom right corner with padding
        padding = 20
        position = (img.width - watermark_width - padding, img.height - watermark_height - padding)
